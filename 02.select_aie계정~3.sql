...
SELECT EMP_NAME,SALARY*12,(SALARY*(1+BONUS)*12),(SALARY*(1+BONUS)*12)-((SALARY*12)*0.03) "실수령액"
FROM EMPLOYEE; 
...
SELECT EMP_NAME,SALARY,(SALARY*(1+BONUS)*12)-((SALARY*12)*0.3),HIRE_DATE
FROM EMPLOYEE
WHERE (SALARY*(1+BONUS)*12)-((SALARY*12)*0.3) <= 50000000;
