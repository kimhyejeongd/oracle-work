...
/*
UPDATE TB_PRODUCT
   SET STOCK_QUANT = STOCK_QUANT + 현재 입고된 수량(INSERT된 자료의 STOCK_COUNT값을 빼줌)
...
/
INSERT INTO TB_PROSALE
VALUES(SEQ_TCODE.NEXTVAL,202,SYSDATE,5,1200000);
INSERT INTO TB_PROSALE
VALUES(SEQ_TCODE.NEXTVAL,201,SYSDATE,3,2000000);
  ...
  SELECT STOCK_QUANT
    ...
    THEN 
     UPDATE TB_PRODUCT
      ...
      WHERE PCODE=:NEW.PCODE;
      ELSE
      RAISE_APPLECATION_ERROR(-20001,'재고수량부족');
      END IF;
END;
/
